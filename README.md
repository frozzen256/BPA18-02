...
2. Реализовать решение на языке Java
используя процедурный подход
...
6. Добавить обработку исключений и логирование выполнения программы
Выполнение присылается пулреквестом в ветку Dev.
